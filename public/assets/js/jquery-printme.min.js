 ...
 */
 jQuery.fn.printMe = function(t) {
     ...
     return this.each(function() {
         ...
         n.document.write("</head><body>"),"" != e.img && n.document.write("<span class='pull-right'>CA Library</span><br /><img id='logo' src='" + e.img + "''/><br />"), "" != e.title && n.document.write("<h4>" + e.title + "</h4>"), n.document.write(t.html()), n.document.write('<script type="text/javascript">function closeme(){window.close();}setTimeout(closeme,50);window.print();</script></body></html>'), n.document.close()
     })
 };
